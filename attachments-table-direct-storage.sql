...
-- Create attachments table to store file data directly in database
CREATE TABLE IF NOT EXISTS attachments (
    ...
    file_data BYTEA NOT NULL, -- Store actual file binary data
...
COMMENT ON TABLE attachments IS 'Stores file attachments with binary data directly in database';
...
COMMENT ON COLUMN attachments.file_data IS 'Binary file data stored directly in database';
