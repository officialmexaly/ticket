        ...
        <div className="px-6 py-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground mt-1">Manage employees, performance, and organizational structure</p>
            </div>
                    ...
                    >
                      <div className="flex items-center justify-between mb-2">
                        <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                          step.completed ? 'bg-green-600 text-white' : 'bg-blue-100 text-blue-600'
                        }`}>
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      <Badge variant="secondary">{pendingTimeOff}</Badge>
                      <ArrowRight className="w-4 h-4" />
                    </div>
                  </Button>
                    ...
                    {employees.slice(0, 5).map((employee) => (
                      <div key={employee.id} className="flex items-center space-x-4">
                        ...
                        <div className="flex-1">
                          <p className="text-sm font-medium">{employee.display_name || `${employee.first_name} ${employee.last_name}`}</p>
